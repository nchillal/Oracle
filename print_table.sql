--Use the below statements to dispaly the ouput of a select statement
--set serveroutput on
--SQL> exec print_table('select * from dba_users where username = ''SYSTEM''');
--PROCEDURE TO CREATE COLUMN DISPLAY
create or replace procedure print_table (p_query in varchar2, p_date_fmt in varchar2 default 'dd-mon-yyyy hh24:mi:ss')
